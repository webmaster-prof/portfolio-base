  ...
  return (
    <section className='contacts' id="contacts">
        <div className="container">
            <h2 className="contacts__title title" data-aos="fade-up">Напишіть мені</h2>
            <form className="contacts__form">
                <div className="contacts__form-block" data-aos="fade-up" data-aos-delay="200">
                ...
                <div className="contacts__form-block" data-aos="fade-up" data-aos-delay="300">  
                ...
                <div className="contacts__form-block" data-aos="fade-up" data-aos-delay="400">
